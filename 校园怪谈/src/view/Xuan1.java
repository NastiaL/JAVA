 ...
 * @author  __USER__
 */
public class Xuan1 extends javax.swing.JFrame {
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new Xuan1(null).setVisible(true);
			}
		});
	}
