 ...
 * @author  __USER__
 */
public class Xuan12 extends javax.swing.JFrame {

	/** Creates new form XY2 */
	private Uers u;
	Photo J;
	public Xuan12(Uers u) {
		this.u = u;
		initComponents();
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new Xuan12(null).setVisible(true);
			}
		});
	}
