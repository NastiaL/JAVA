 ...
 * @author  __USER__
 */
public class Xuan13 extends javax.swing.JFrame {

	/** Creates new form XY2 */
	private Uers u;
	Photo J;
	public Xuan13(Uers u) {
		this.u = u;
		initComponents();
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) throws IOException, ClassNotFoundException {
		new X13S2(u).setVisible(true);
		this.dispose();
	}

	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
		new X13S1(u).setVisible(true);
		this.dispose();
	}
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new Xuan13(null).setVisible(true);
			}
		});
	}
